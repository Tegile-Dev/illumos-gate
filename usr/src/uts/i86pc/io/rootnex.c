...
#ifdef	DDI_MAP_DEBUG
	cmn_err(CE_CONT, "rootnex: <%s,%s> <0x%" PRIx64 ", 0x%" PRIx64
	    ", 0x%" PRIx64 "> offset %d len %d "
...
#ifdef	DDI_MAP_DEBUG
	ddi_map_debug(
	    "rootnex_map_regspec: <0x%" PRIx64 " 0x%" PRIx64 " 0x%" PRIx64
	    "> handle 0x%x\n", rp->regspec_bustype, rp->regspec_addr,
...
#ifdef	DDI_MAP_DEBUG
		ddi_map_debug( "rootnex_map_regspec: \"Mapping\" %d bytes I/O "
...
#ifdef	DDI_MAP_DEBUG
	ddi_map_debug(
	    "rootnex_map_handle: <0x%" PRIx64 " 0x%" PRIx64 " 0x%" PRIx64
	    "> handle 0x%x\n", rp->regspec_bustype, rp->regspec_addr,
	    rp->regspec_size, mp->map_handlep);
#endif	/* DDI_MAP_DEBUG */
